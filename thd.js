...
THD_CHAPTERS[thdKey('Potentiels thermodynamiques : enthalpie, énergie libre, enthalpie libre')] = {
  objectives: [
    ...
    "Analyser pourquoi les travaux fondateurs de Josiah Willard Gibbs (1876-1878), publiés dans une revue américaine obscure, sont restés pratiquement ignorés pendant près de vingt ans avant leur reconnaissance en Europe"
  ],
  prereqs: ["Deuxième principe : entropie et évolutions irréversibles"],
  bodyHtml: `
    ...
    <p>Entre 1876 et 1878, un discret professeur de physique mathématique de l'université Yale, Josiah Willard Gibbs, publie en trois parties un mémoire d'environ 300 pages, <em>On the Equilibrium of Heterogeneous Substances</em>, dans les obscures <em>Transactions of the Connecticut Academy of Sciences</em> — une revue à la diffusion si confidentielle que le texte passe presque inaperçu aux États-Unis. Il y pose pourtant, à lui seul, les fondations de toute la thermodynamique chimique moderne : l'enthalpie libre, le potentiel chimique, la règle des phases. Il faudra attendre 1892 et sa traduction en allemand par le chimiste Wilhelm Ostwald pour que l'Europe scientifique prenne toute la mesure de ce travail — révélant, avec vingt ans de retard, l'un des textes fondateurs de la physico-chimie.</p>
    <p>Le critère de spontanéité que Gibbs a mis au jour gouverne aujourd'hui la conception des batteries, la modélisation de la corrosion des métaux, la stabilité des médicaments en pharmacie et le repliement des protéines en biologie. Ce chapitre construit les trois potentiels — enthalpie, énergie libre, enthalpie libre — et montre comment choisir, selon les conditions expérimentales, celui qui prédit correctement le sens d'évolution spontanée d'un système.</p>
    ...
    <div class="key-point">
      <span class="eyebrow">🤔 Pause réflexive</span>
      Le critère $\\Delta G\\leqslant0$ semble interdire toute réaction « défavorable » ($\\Delta G>0$). Pourtant, la vie biologique enchaîne en permanence des réactions individuellement défavorables — synthèse des protéines, de l'ADN. Comment expliquer qu'elles se produisent malgré tout ? La réponse tient au couplage énergétique : la cellule les associe systématiquement à l'hydrolyse de l'ATP, fortement favorable, de sorte que le bilan global des deux réactions couplées reste négatif.
    </div>
    ...
    <div class="key-point">
      <span class="eyebrow">🤔 Pause réflexive</span>
      $F$ et $G$ existent tous deux, mais les chimistes utilisent presque exclusivement $G$. Sachant que la quasi-totalité des réactions de laboratoire ou industrielles se déroulent à l'air libre (pression atmosphérique constante) plutôt qu'en récipient rigide à volume fixé, pourquoi $G$ s'est-il imposé comme LE potentiel de référence en chimie, reléguant $F$ à un rôle plus marginal (surtout utile en physique statistique) ?
    </div>
  ...
  extraHtml: `
    ...
    <h3>5. Frontière de la recherche</h3>
    <p>Les calculs de perturbation d'énergie libre (<em>Free Energy Perturbation</em>, FEP), fondés théoriquement dès 1954 par Robert Zwanzig, connaissent depuis le milieu des années 2010 un essor majeur en chimie pharmaceutique computationnelle : une étude de référence publiée en 2015 par Lingle Wang et son équipe (<em>Journal of the American Chemical Society</em>) démontre qu'un protocole FEP moderne peut prédire l'enthalpie libre de liaison $\\Delta G$ entre une molécule candidate et sa protéine cible avec une précision inférieure à 1 kcal/mol — avant toute synthèse en laboratoire. Ces méthodes, aujourd'hui utilisées en routine par l'industrie pharmaceutique, réduisent considérablement le nombre de molécules à synthétiser et tester physiquement lors de la recherche de nouveaux médicaments.</p>

    <h3>Synthèse visuelle</h3>
    <p>Identifier les conditions expérimentales (isochore ? isobare ? isotherme ?) → choisir le potentiel adapté ($U$, $H$, $F$ ou $G$) → calculer $\\Delta G=\\Delta H-T\\Delta S$ si $T,P$ fixées → comparer à 0 pour statuer sur la spontanéité → à l'équilibre, $G$ est minimale</p>
    <div class="key-point">
      <span class="eyebrow">Équation maîtresse du chapitre</span>
      <div class="formula-box">$$\\Delta G = \\Delta H - T\\Delta S \\qquad \\Delta G \\leqslant 0 \\ (\\text{spontané à } T,P \\text{ fixées})$$</div>
    </div>
    <div class="key-point">
      <span class="eyebrow">💭 Questions de réflexion</span>
      <ul>
        <li>Et si une réaction avait $\\Delta H=0$ exactement : quel terme déciderait alors seul de sa spontanéité ?</li>
        <li>Pourquoi les chimistes utilisent-ils presque toujours $G$ plutôt que $F$, alors que les deux potentiels existent et sont également valides ?</li>
        <li>Quelle serait la conséquence, pour la recherche pharmaceutique, si l'on pouvait un jour calculer $\\Delta G$ de liaison avec une précision parfaite avant toute synthèse en laboratoire ?</li>
      </ul>
    </div>
    <div class="key-point">
      <span class="eyebrow">📚 Références bibliographiques</span>
      <ul>
        <li>J. W. Gibbs, <em>On the Equilibrium of Heterogeneous Substances</em>, Transactions of the Connecticut Academy of Sciences, 1876-1878 — mémoire fondateur de la thermodynamique chimique</li>
        <li>J. P. Pérez, <em>Thermodynamique — Fondements et applications</em>, Dunod — référence standard pour les potentiels thermodynamiques de niveau L2</li>
        <li>L. Wang et al., « Accurate and Reliable Prediction of Relative Ligand Binding Potency... », <em>Journal of the American Chemical Society</em>, 2015</li>
      </ul>
    </div>
    <p style="font-style:italic; color:var(--ink-soft); margin-top:16px;">Vingt années d'obscurité avant la reconnaissance : Gibbs rappelle qu'une idée juste finit toujours par s'imposer, même publiée dans la plus confidentielle des revues. Rendez-vous au chapitre suivant, « Changements d'état des corps purs », pour voir l'enthalpie libre à l'œuvre dans la construction des diagrammes de phases.</p>
  `
};
...
THD_CHAPTERS[thdKey('Changements d\'état des corps purs et diagrammes de phases')] = {
  objectives: [
    ...
    "Analyser comment l'ingénieur Émile Clapeyron (1834) a sauvegardé et formalisé mathématiquement les travaux de Carnot, alors tombés dans un oubli quasi total depuis 1824"
  ],
  ...
  bodyHtml: `
    ...
    <p>En 1834, dix ans après la publication confidentielle des <em>Réflexions</em> de Carnot (chapitre 5) et un an après sa mort dans l'anonymat, l'ingénieur français Émile Clapeyron republie les idées de Carnot dans un mémoire qui leur donne enfin une forme mathématique rigoureuse, appuyée sur le diagramme $(P,V)$. C'est ce travail de sauvetage et de reformulation qui permettra, une vingtaine d'années plus tard, à Clausius d'établir la relation qui porte aujourd'hui leurs deux noms : Clausius-Clapeyron.</p>
    <p>Cette relation gouverne des phénomènes très concrets : pourquoi l'eau bout à une température plus basse en haute montagne, pourquoi un autocuiseur cuit plus vite en élevant la pression, ou pourquoi la glace, contrairement à presque tous les autres solides, flotte sur son propre liquide. Ce chapitre construit les outils — diagramme de phases, enthalpie de changement d'état, relation de Clausius-Clapeyron — qui rendent ces observations quantitatives.</p>
    ...
    <div class="key-point">
      <span class="eyebrow">🤔 Pause réflexive</span>
      Au-delà du point critique, un fluide supercritique n'est ni tout à fait liquide, ni tout à fait gazeux — la distinction elle-même perd son sens. Cette zone grise interroge la notion même d'« état de la matière » : si liquide et gaz peuvent se transformer l'un en l'autre de façon parfaitement continue (en contournant le point critique sur le diagramme), en quel sens peut-on encore dire qu'il s'agit de deux états réellement distincts ?
    </div>
    ...
    <div class="key-point">
      <span class="eyebrow">🤔 Pause réflexive</span>
      La relation de Clausius-Clapeyron a été établie sans référence à une substance particulière — elle découle uniquement de l'égalité des enthalpies libres molaires des deux phases. Pourtant, elle prédit correctement le comportement normal de la quasi-totalité des corps purs ET l'anomalie de l'eau. Qu'est-ce que cela révèle sur la nature véritablement universelle des lois thermodynamiques, indépendamment des détails microscopiques de chaque substance ?
    </div>
  ...
  extraHtml: `
    ...
    <h3>5. Frontière de la recherche</h3>
    <p>Une question reste activement débattue en recherche sur l'eau : celle d'un second point critique hypothétique, propre à l'eau <em>liquide</em>, proposé dès 1992 par Peter Poole et ses collègues (<em>Nature</em>) pour expliquer certaines anomalies de l'eau surfondue. Cette transition supposée entre deux formes liquides de densités différentes se situerait dans une région de température et de pression si difficile d'accès expérimentalement — l'eau y cristallise presque instantanément — qu'elle est surnommée le « no man's land » du diagramme de phases de l'eau. Ce second point critique n'a, à ce jour, jamais été observé directement, mais des expériences récentes de diffraction sur eau ultra-rapidement refroidie apportent des indices indirects en sa faveur.</p>

    <h3>Synthèse visuelle</h3>
    <p>Identifier la phase stable à $(P,T)$ donné (plus basse enthalpie libre) → localiser le point sur le diagramme $(P,T)$ → si sur une courbe de coexistence, appliquer Clausius-Clapeyron → déterminer le signe de la pente selon le signe de $\\Delta_{trans}V$ → cas particulier de l'eau : $\\Delta_{fus}V<0$ → pente négative</p>
    <div class="key-point">
      <span class="eyebrow">Équation maîtresse du chapitre</span>
      <div class="formula-box">$$\\frac{dP}{dT} = \\frac{\\Delta_{trans}H}{T\\,\\Delta_{trans}V}$$</div>
    </div>
    <div class="key-point">
      <span class="eyebrow">💭 Questions de réflexion</span>
      <ul>
        <li>Et si l'eau n'avait pas cette anomalie de densité (glace plus dense que le liquide, comme la majorité des corps purs) : les lacs gèleraient-ils encore de la surface vers le fond, et quelles en seraient les conséquences pour la vie aquatique en hiver ?</li>
        <li>Pourquoi le point triple, plutôt que le point de fusion à pression atmosphérique, a-t-il longtemps servi de référence pour définir l'échelle de température ?</li>
        <li>Quelle serait la conséquence, pour la production d'électricité, si les cycles à $CO_2$ supercritique remplaçaient largement les cycles à vapeur d'eau dans les centrales thermiques ?</li>
      </ul>
    </div>
    <div class="key-point">
      <span class="eyebrow">📚 Références bibliographiques</span>
      <ul>
        <li>É. Clapeyron, <em>Mémoire sur la puissance motrice de la chaleur</em>, 1834 — reformulation mathématique des idées de Carnot</li>
        <li>J. P. Pérez, <em>Thermodynamique — Fondements et applications</em>, Dunod — référence standard pour les changements d'état de niveau L2</li>
        <li>P. H. Poole, F. Sciortino, U. Essmann, H. E. Stanley, « Phase behaviour of metastable water », <em>Nature</em>, 1992</li>
      </ul>
    </div>
    <p style="font-style:italic; color:var(--ink-soft); margin-top:16px;">Sans Clapeyron pour les reformuler mathématiquement en 1834, les idées de Carnot auraient peut-être sombré dans un oubli définitif : parfois, une théorie juste a autant besoin d'un bon traducteur que d'un bon auteur. Rendez-vous au chapitre suivant, « Transferts thermiques », pour la dernière étape de ce cours — comment la chaleur se propage réellement dans l'espace et dans le temps.</p>
  `
};
...
THD_CHAPTERS[thdKey('Transferts thermiques : conduction, convection, rayonnement')] = {
  objectives: [
    ...
    "Analyser comment Josef Stefan (1879) a d'abord établi empiriquement la loi en $T^4$ à partir de mesures expérimentales, avant sa démonstration théorique par son ancien étudiant Ludwig Boltzmann en 1884"
  ],
  ...
  bodyHtml: `
    ...
    <p>En 1879, le physicien viennois Josef Stefan analyse des mesures expérimentales de rayonnement thermique et en déduit, de façon purement empirique, que la puissance rayonnée par un corps chaud croît comme la puissance quatrième de sa température absolue. Il faudra attendre cinq ans, et le travail théorique de son propre ancien étudiant, Ludwig Boltzmann — déjà rencontré au chapitre 4 pour l'entropie — pour que cette loi empirique reçoive, en 1884, une justification rigoureuse à partir de la thermodynamique et de la théorie électromagnétique de Maxwell.</p>
    <p>Cette loi en $T^4$ explique, entre autres, pourquoi un tisonnier porté au rouge puis au blanc rayonne une chaleur disproportionnée par rapport à l'augmentation de température apparente, ou pourquoi la surface du Soleil (≈5800 K) rayonne des millions de fois plus intensément, par unité de surface, qu'un radiateur domestique. Ce chapitre construit les trois lois — Fourier, Newton, Stefan-Boltzmann — qui permettent de quantifier chacun des trois modes de transfert thermique.</p>
    ...
    <div class="key-point">
      <span class="eyebrow">🤔 Pause réflexive</span>
      L'analogie entre la loi de Fourier et la loi d'Ohm n'est pas une simple coïncidence pédagogique : flux thermique, courant électrique, débit de fluide dans une conduite obéissent tous à des lois de la même forme (un flux proportionnel à une différence de potentiel, divisée par une résistance). Qu'est-ce que cette parenté mathématique profonde entre des phénomènes physiques aussi différents révèle sur la structure des lois de transport en physique ?
    </div>
    ...
    <div class="key-point">
      <span class="eyebrow">🤔 Pause réflexive</span>
      La loi de Stefan-Boltzmann, appliquée à la Terre vue depuis l'espace comme un corps quasi-noir, permet de calculer sa température d'équilibre radiatif théorique à partir du seul rayonnement solaire reçu et réémis — un résultat nettement plus froid que la température moyenne réelle observée à sa surface. En quoi cet écart, mesurable grâce à une loi physique vieille de 150 ans, constitue-t-il l'une des preuves quantitatives les plus directes de l'effet de serre atmosphérique ?
    </div>
  ...
  extraHtml: `
    ...
    <h3>5. Frontière de la recherche</h3>
    <p>En 2014, une équipe de Stanford dirigée par Aaswath Raman et Shanhui Fan démontre, dans <em>Nature</em>, un matériau capable de « refroidissement radiatif passif » : un revêtement qui réfléchit presque toute la lumière solaire incidente tout en émettant efficacement dans une bande spectrale précise (8-13 μm) où l'atmosphère terrestre est transparente — la « fenêtre atmosphérique » — permettant d'évacuer de la chaleur directement vers le froid de l'espace (≈3 K), même en plein soleil. Commercialisées depuis, ces peintures radiatives peuvent refroidir une surface de plusieurs degrés sous la température ambiante sans aucune consommation électrique. Une question reste ouverte pour la recherche : jusqu'à quelle échelle (toitures individuelles, quartiers entiers, véhicules) cette technologie peut-elle réduire significativement la demande mondiale de climatisation active ?</p>

    <h3>Synthèse visuelle</h3>
    <p>Identifier le mode dominant (support matériel ? fluide en mouvement ? température très élevée ?) → conduction : loi de Fourier, résistance thermique $R_{th}=e/(\\lambda A)$ → convection : loi de Newton $\\Phi=hA(T_p-T_f)$ → rayonnement : loi de Stefan-Boltzmann $\\Phi/A=\\varepsilon\\sigma T^4$ → sommer les contributions si plusieurs modes coexistent simultanément</p>
    <div class="key-point">
      <span class="eyebrow">Équation maîtresse du chapitre</span>
      <div class="formula-box">$$\\frac{\\Phi}{A} = \\varepsilon\\,\\sigma\\,T^4 \\qquad \\sigma\\approx5{,}67\\times10^{-8}\\ W\\cdot m^{-2}\\cdot K^{-4}$$</div>
    </div>
    <div class="key-point">
      <span class="eyebrow">💭 Questions de réflexion</span>
      <ul>
        <li>Et si la Terre n'avait aucune atmosphère : sa température d'équilibre radiatif serait-elle plus proche ou plus éloignée de sa température de surface actuelle ?</li>
        <li>Pourquoi se brûle-t-on davantage en touchant une casserole en aluminium qu'une casserole en céramique posée sur le même feu, alors que les deux sont à la même température ?</li>
        <li>Quelle serait la conséquence, pour la climatisation urbaine, si les peintures à refroidissement radiatif se généralisaient à grande échelle sur les toitures ?</li>
      </ul>
    </div>
    <div class="key-point">
      <span class="eyebrow">📚 Références bibliographiques</span>
      <ul>
        <li>J. Stefan, <em>Über die Beziehung zwischen der Wärmestrahlung und der Temperatur</em>, 1879 — établissement empirique de la loi en $T^4$</li>
        <li>J. P. Pérez, <em>Thermodynamique — Fondements et applications</em>, Dunod — référence standard pour les transferts thermiques de niveau L2</li>
        <li>A. P. Raman, M. A. Anoma, L. Zhu, E. Rephaeli, S. Fan, « Passive radiative cooling below ambient air temperature under direct sunlight », <em>Nature</em>, 2014</li>
      </ul>
    </div>
    <p style="font-style:italic; color:var(--ink-soft); margin-top:16px;">Stefan a mesuré avant de comprendre, Boltzmann a compris cinq ans après avoir mesuré : la physique avance parfois par l'observation patiente, parfois par la théorie pure, et le plus souvent par leur dialogue. <strong>Ce chapitre clôt la matière Thermodynamique (8/8 chapitres)</strong> — direction « Optique physique » pour la suite du programme de Physique L2.</p>
  `
};
