/* Service worker — E-Student University
   ...
   - chunks/*.js (contenu des cours) et images locales : « stale-while-revalidate » = copie du
     cache servie tout de suite, mise à jour en arrière-plan pour la visite suivante.
