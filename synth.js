...
SYNTH_CHAPTERS[synKey("Analyse rétrosynthétique : stratégies et méthodologie")] = {
  ...
  bodyHtml: `
    <p>La synthèse organique consiste à construire une molécule cible, souvent complexe, à partir de matières premières simples et disponibles. Face à une cible, il est presque toujours impossible de « deviner » directement la suite de réactions à effectuer : la méthode utilisée depuis les travaux d'E. J. Corey (prix Nobel 1990) consiste à raisonner <strong>à l'envers</strong>, de la cible vers les précurseurs. C'est l'<strong>analyse rétrosynthétique</strong>, cœur méthodologique de ce module.</p>
...
SYNTH_CHAPTERS[synKey("Oléfination : Wittig, HWE et méthodes apparentées")] = {
  ...
  bodyHtml: `
    <p>La déconnexion d'une double liaison C=C est l'une des plus utiles en rétrosynthèse, car elle donne directement accès à deux fragments carbonylés simples. La réaction de <strong>Wittig</strong>, découverte par Georg Wittig (prix Nobel de chimie 1979), et ses variantes modernes, réalisent cette transformation de façon fiable et souvent stéréosélective.</p>
